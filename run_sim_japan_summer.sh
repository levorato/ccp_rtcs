...
echo "CCP Julia Japan summer experiment script start."

cd /users/mlevorato/doutorado/robusto/RCCP
/users/mlevorato/julia-1.6.0/bin/julia --threads=8 run_sim_instance_deltamin10_summer.txt.jl
